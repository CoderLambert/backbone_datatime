define({
    ...
    "instancecheck_this_option_to_enable_media_encryption_support_in_bmc_bnoteb_if_active_media_redirection_is_available_then_allow_this_field_alone_to_change_and_media_encryption_cannot_be_disabled_when_nonsecure_communication_is_not_allowed": "Check this option to enable Media Encryption support in BMC <b>NOTE:<\/b> If Active media redirection is available then allow this field alone to change and Media Encryption cannot be disabled when non-secure communication is not allowed.",

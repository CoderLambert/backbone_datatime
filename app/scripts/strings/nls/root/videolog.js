define({
	...
	"<br> Click <strong><i class='ion ion-close-circled '> </i></strong> to delete the selected video file."+
	...
	"<br> Click <strong><i class='fa fa-times btn-info'> </i></strong> to close the selected video file."+
	"<br> Click <strong><i class='fa fa-play btn-info'> </i> <i class='fa fa-pause btn-info'> </i></strong> to Play/Pause the selected video file."+
	...
	"Temporary_failure_in_mounting_remote_share": "Temporary failure in mounting remote share."
});
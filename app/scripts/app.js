define([
    ...
    function(
        $, _, Backbone, DateTimeModel, moment, bootstrap, moment_timezone, tzMetaData,
    ) {
        ...
        var view = Backbone.View.extend({
            ...
            initialize: function() {
                ...
                this.model.bind('change:sync_cycle_ntp', this.updateSyncCycleNtp, this);
                ...
                //     mapPoints.push(tzMetaData.zones);
                // }
            ...
            changeTimeZone: function(e) {
                ...
                for (var i in that.mapPoints) {
                    if (that.mapPoints[i].name == dropDownTimeZone) {
                        that.newPoint(that.mapPoints[i]);
                        that.clickPoint = that.mapPoints[i];
                    }
                }
                ...
                if (dropDownTimeZone == '#') {
                    ...
                    // this.clickPoint.name = this.model.get('timezone');
                } else {
                    this.model.set("timezone", dropDownTimeZone);
                    // this.clickPoint.name = dropDownTimeZone;
                }
            ...
            updateTimezone: function(model, value) {
                console.log($('#idtimezone').val(value));
            ...
            updateSyncCycleNtp: function(model, value) {
                $('#idsync_cycle_ntp').val(value);
            },
            ...
            clickMap: function(ev) {
                ...
                $("#idtimezone").select2("val", this.clickPoint.name);
            },
            ...
            save: function() {
                ...
                $("#save-icon").removeClass().addClass("ion-load-b");

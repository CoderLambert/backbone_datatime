        ...
        validation: {
            time_out: {
                fn: function(value, attr, computedState) {
                    if (computedState.state == 1 && value != -1 && value != '2147483647' && (parseInt(value, 10) % 60 != 0 || ((computedState.service_name == 'web' || computedState.service_name == 'kvm') && !(value >= 300 && value <= 1800) ) || ((computedState.service_name == 'ssh' || computedState.service_name == 'telnet' || computedState.service_name == 'solssh') && (!(value >= 60 && value <= 1800))))) {
                        return true;
                    } else {
                        return false;
                    }

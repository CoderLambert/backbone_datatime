        ...
        validation: {
            ...
            primary_smtp_enable: {
                fn: function(value, attr, computedState) {
                    if(value < 1 && (computedState.primary_server_ip == "" || (!(/^(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[1-9])(\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9]{1,2})){2}(\.(25[0-4]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[1-9]))$/.test(computedState.primary_server_ip))))) {
                        return true;
                    } else {
                        return false;
                    }
            ...
            primary_server_ip: {
                fn: function(value, attr, computedState) {
                	...
                	if (computedState.primary_smtp_enable == 1 &&  (!(/^(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[1-9])(\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9]{1,2})){2}(\.(25[0-4]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[1-9]))$/.test(value)))) {
                        return true;
                    } else {
                        return false;
                    }

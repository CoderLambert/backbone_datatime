define(["jquery", "underscore", "backbone", "app", "i18n!strings/nls/fwimage_location"],
        ...
        validation: {
            server_address: {
                required: function(value, attr, computedState) {
                    if (computedState.protocol_type == 'tftp') {
                        return true;
                    } else {
                        return false;
                    }
                ...
                msg: locale.invalid_tftp_server_address
            },
            image_name: {
                required: function(value, attr, computedState) {
                    if (computedState.protocol_type == 'tftp') {
                ...
                msg: locale.image_name_is_required
            },
            retry_count: {
                required: false,
                range: [0, 255],
                msg: locale.invalid_tftp_retry_count
            }
        },

        url: function() {
            return "/api/maintenance/fwimage_location"
        }
    });

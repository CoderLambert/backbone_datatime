define(["jquery", "underscore", "backbone", "app", "i18n!strings/nls/sol_remote_storage"],
    ...
    var model = Backbone.Model.extend({
        ...
        validation: {
            log_size: {
                required: true,
                pattern: 'number',
                msg: locale.invalid_log_sizerefer_help_for_more_information
            },
            log_file_count: {
                required: true,
                range: [1, 10],
                msg: locale.invalid_log_file_countrefer_help_for_more_information
            },
            ip_address: {
            ...
            user_name: {
                required: function(value, attr, computedState) {
                    if (computedState.share_type == 'CIFS') {
                        return true;
                    } else {
                        return false;
                    }
        ...
        url: function() {
            return "/api/settings/video/sol-remote-storage"
        }
    });
